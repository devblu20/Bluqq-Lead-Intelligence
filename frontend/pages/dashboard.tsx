    ...
    <AppLayout title="Dashboard">
      <style>{`
        ...
        @media (max-width: 600px) {
          ...
          /* hide priority badge on small screens, keep status */
        ...
        @media (max-width: 900px) {
          .db-action-grid { grid-template-columns: repeat(2, 1fr); gap: 12px; }
        }
        @media (max-width: 560px) {
          .db-action-grid { grid-template-columns: 1fr; gap: 10px; }
        }
        ...
        @media (max-width: 480px) {
          .db-action-card { padding: 16px 18px; gap: 14px; }
          .db-action-card:hover { transform: none; }
        }
        .db-action-icon {
