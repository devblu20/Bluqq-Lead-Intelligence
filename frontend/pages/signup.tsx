    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sg-step { display: flex; align-items: center; gap: 8px; font-size: 12px; font-weight: 500; }
        .sg-step-circle {
        ...
        /* Select — mirrors .sg-input exactly */
        .sg-select {
        ...
        .sg-select option {
          background: #0d1a2e; color: #F9FAFB;
          padding: 10px 14px; font-size: 14px;
        }
        .sg-select.empty { color: rgba(255,255,255,0.18); }
        .sg-select:not(.empty) { color: #F9FAFB; }
        .sg-chevron {
          position: absolute; right: 13px; top: 50%; transform: translateY(-50%);
          pointer-events: none; color: rgba(255,255,255,0.28);
          display: flex; align-items: center; transition: color 0.2s;
        }
        .sg-field:focus-within .sg-chevron { color: rgba(96,165,250,0.7); }
